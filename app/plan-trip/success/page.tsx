...
const Success = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="success-text font-semibold text-2xl text-center font-heading">
      ...
      <Link href="/" className="success-link underline text-emerald-600 font-medium font-heading">
        Back to homepage
      </Link>
    </div>
  );
